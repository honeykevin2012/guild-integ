 ...
 * @author kevin
 */
public class MessageUserJoinGuildApplyTemplate extends MessageTemplate{
	private static String NODE_NAME = "/setting/messageUserJoinGuildApply/messageUserJoinGuildApplyTemplate";
	private static String NODE_TITLE_NAME = "/setting/messageUserJoinGuildApply";
	private static String SUB_NODE_NAME = "joinGuildApply";
	...
	public Map<String, Object> getParameters(Object... values) {
		...
		if(values != null && values.length > 0){
			...
			guildName = values[1].toString();
			params.put(ConsValues.USER_ID, userId);
			params.put(ConsValues.CONTENT, MessageFormat.format(content, guildName));
		}
		return params;
	}
	...
	public static void main(String[] args) {
		...
		core.setAdapter(new MessageUserJoinGuildApplyTemplate()).transfer(new PracticVirtual(), "4", "公会名").send();
	}
}
