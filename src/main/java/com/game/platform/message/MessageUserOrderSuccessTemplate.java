 ...
 * @author kevin
 */
public class MessageUserOrderSuccessTemplate extends MessageTemplate{
	private static String NODE_NAME = "/setting/messageUserOrderSuccess/messageUserOrderSuccessTemplate";
	private static String NODE_TITLE_NAME = "/setting/messageUserOrderSuccess";
	private static String SUB_NODE_NAME = "orderSuccess";
	...
	public static void main(String[] args) {
		...
		core.setAdapter(new MessageUserOrderSuccessTemplate()).transfer(new PracticVirtual(), "4", "201522335888", productNames).send();
	}
}
