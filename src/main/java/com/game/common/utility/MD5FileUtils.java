...
public class MD5FileUtils {
	...
	public static String getStreamMd5(FileInputStream fileInputStream,long length) throws IOException {
	...
	public static String getStreamMd5(byte[] filebyte,long length) throws IOException {
		//FileInputStream in = new FileInputStream(file);
