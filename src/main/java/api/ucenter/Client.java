...
public class Client extends PHPFunctions{
	...
	public static String UC_IP = "http://bbs.nbgame777.com";
	public static String UC_API = "http://bbs.nbgame777.com/uc";
...
//		}
	...
	*/
	...
	public String ssologin(String username, String pwd) {
		Client e = new Client();
		String $ucsynlogin = "";
